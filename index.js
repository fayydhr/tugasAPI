...
// Memanggil fungsi
weatherPanel(["Surabaya", "Sidoarjo"]);
...
function searchWeather() {
  ...
  if (searchInput) {
    getData(searchInput);
    document.getElementById("searchInput").value = ""; // Membersihkan input setelah pencarian
  } else {
    alert("Silakan masukkan nama kota untuk pencarian.");
  }
}

// ... (Kode getData dan fungsi lainnya tetap sama)
